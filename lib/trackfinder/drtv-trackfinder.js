angular.module("trialsTrackmap")
    .directive("trackfinder", function ($rootScope) {
        return {
            restrict: "C",
            template: '\
                <span class="trackfinder__name">#{%::world%} {%::worldName%} ({%trackCount%})</span>\
                ...
                <img class="trackfinder__world" src="{%::src%}" />\
                <map name="trackfinder--{%::world%}" trackfinder-links></map>\
            ',
            scope: true,
                    ...
                    if (parseInt(track.world) === parseInt(params.world) && track.coords) {
                        ...
                        var trackCoords = track.coords.split(","),
                            ...
                            scaledCoords = {
                                ...
                                radius: parseInt(Math.round(80 / scale) / 2)
                            },
