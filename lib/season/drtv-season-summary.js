        ...
        return {
            ...
            template: '\
                ...
                <div ng-repeat="extra in summary.extras" title=""> \
                    ...
                    <span class="season-prize" data-extra="{%::extra.extra%}" data-extra-type="{%::extra.extra_type%}" data-sprite-pointer="{%::extra.sprite_pointer%}"></span> \
                </div> \
            ',
            link: function (scope) {
