angular.module("trialsTrackmap")
    .service("dialogExport", function (dialogService, improveTimes, myJson, $useLocalJsonFiles,
                ...
                var lsKey = improveTimes.autoExportLsKey,
                    dialog = dialogService.confirm({
                        ...
                        <div dialog\
                            ...
                            >\
                            <section ng-if="!useLocalJsonFiles">\
                            ...
                            <section ng-if="!useLocalJsonFiles">\
                                <small>\
                                    <input ng-model="models.autoExport"\
                                           ...
                                           type="checkbox" />\
                                    <span ng-click="toggleAutoExport()" class="label-for-checkbox">\
                                        {%::"dialogs.labels.autoExport"|translate%}\
                                    </span>\
                                </small>\
                            </section>\
                            <section ng-class="{\'with-border-top\':!useLocalJsonFiles}">\
                    ...
                    ',
                        scope: {
                            useLocalJsonFiles: $useLocalJsonFiles,
                            models: {
                            ...
                            toggleAutoExport: function(){
                                this.models.autoExport = this.models.autoExport ? false : true;
                                this.validateAutoExport();
                            },
                            saveFile: function () {
