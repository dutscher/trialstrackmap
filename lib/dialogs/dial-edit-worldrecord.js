angular.module("trialsTrackmap")
    .service("dialogEditWorldRecord", function (improveTimes, dialogService, dialogCreateWRRider, $useLocalJsonFiles) {
            ...
            open: function (trackData) {
                ...
                return dialog.promise.then(function (data) {
                    ...
                    thisScope.confirmSave(trackData, data.newTime, data.riderName).then(function () {
                        improveTimes.WRTimes.setScope(dialog.scope);
                        improveTimes.WRTimes.save(trackData.id, data.riderId, data.newTime).then(function () {
