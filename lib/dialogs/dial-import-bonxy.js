                    ...
                    scope: {
                        ...
                        validateImportData: function (_data_) {
                            ...
                            function addTime(mode, trackId, trackData) {
                                if (trackData) {
                                    ...
                                    tracksData[trackId][mode] = {
                                        ...
                                        "myBike": trackData.bikeId + "-" + (trackData.paintjob || 0 ),
                                        "myFaults": trackData.fault
                                    };
                                }
                            }
                            ...
                            Object.keys(_data_.tracks).forEach(function (trackId) {
                                ...
                                addTime("normal", trackId, track.normal);
                                addTime("donkey", trackId, track.donkey);
                                addTime("crazy", trackId, track.crazy);
                            });
