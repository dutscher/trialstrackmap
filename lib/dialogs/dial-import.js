angular.module("trialsTrackmap")
    .service("dialogImport", function (dialogService, improveTimes, myJson, $useLocalJsonFiles,
                ...
                var dialog = dialogService.confirm({
                    tpl: '\
                        <div dialog\
                            ...
                            <section class="with-border-top" ng-if="!useLocalJsonFiles">\
                    ...
                    scope: {
                        ...
                        importStorage: function (_storageId_) {
                            myJson.get(_storageId_).then(
                                function (json) {
                                    if (json !== null) {
                                        localStorageService.set(myJson.getStorageParam(), _storageId_);
                        ...
                        validateImportData: function (_data_, _type_) {
                            ...
                            thisScope.openConfirm({
                                exportDate: $filter("humanReadableDate")(_data_.dateEdit, true)
                            }).then(function () {
                                improveTimes
                                    .setScope(drtvScope)
                                    .importData(_data_);
