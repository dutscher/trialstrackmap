angular.module("trialsTrackmap")
    .service("improveTimes", function (localStorageService, security, WRTimes, $filter, $timeout) {
        ...
        function humanReadableDate(timestamp, withDelimiter) {
            ...
            return datePre.join(".") + " " + dateTime.join(":");
        }
