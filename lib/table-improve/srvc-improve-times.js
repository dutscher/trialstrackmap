                    ...
                    bikeTypeKeys.forEach(function (_bikeType_) {
                        ...
                        keys.forEach(function (key, index) {
                            ...
                            if (data === error || data[index] === "" || !data[index]) {
                                initData[_mode_][_bikeType_][clearKey] = (clearKey === "myRank") ? error : "";
                            } else if(clearKey === "myBike") {
                                var bikeData = data[index].split("-");
                                initData[_mode_][_bikeType_][clearKey] = {
                                    bikeId: bikeData[0],
                                    paintjobId: bikeData[1]
                                };
                            } else {
                                initData[_mode_][_bikeType_][clearKey] = data[index];
                            }
                        });

                        if (!("times" in trackData)) {
                            initData[_mode_][_bikeType_].differenceTime = "";
                            initData[_mode_][_bikeType_].differenceTimeWR = "";
                            return;
                        }

                        // difference myTime to worldRecord
                        if (initData[_mode_][_bikeType_].myTime !== error
                            && trackData.times.worldRecord
                            && trackData.times.worldRecord[_mode_][_bikeType_].time !== error) {
                            initData[_mode_][_bikeType_].differenceTime = thisScope
                                .compareTime(initData[_mode_][_bikeType_].myTime, trackData.times.worldRecord[_mode_][_bikeType_].time);
                        }

                        // difference myGoal to myTime
                        if (initData[_mode_][_bikeType_].myTime !== error
                            && initData[_mode_][_bikeType_].myGoal !== error) {
                            initData[_mode_][_bikeType_].differenceTimeMyGoal = thisScope
                                .compareTime(initData[_mode_][_bikeType_].myTime, initData[_mode_][_bikeType_].myGoal);
                        }
                        ...
                        if (trackData.times.worldRecord
                            ...
                            && trackData.times.worldRecord[_mode_][_bikeType_].time !== error) {
                            initData[_mode_][_bikeType_].differenceTimeWR = thisScope
