                    ...
                    array.sort(function (a, b) {
                        ...
                        switch (sortType) {
                            ...
                            case "differenceTimeWR":
                                ...
                                if (!("time" in a.improve[mode][bikeType][sortType]
                                    && "time" in b.improve[mode][bikeType][sortType])) {
                                    return 0;
                                    // compare each other
                                } else {
                                    x = a.improve[mode][bikeType][sortType].time;
                                    y = b.improve[mode][bikeType][sortType].time;
                                }
                                break;
                        }
