angular.module("trialsTrackmap")
    .directive("trackStats", function(trackStats, $rootScope){
        return {
            restrict: "A",
            template: '\
                {%counts.released%} {%"page.rightSidebar.released"|translate%} ({%counts.bunker.length%} {%"page.rightSidebar.only_bunker"|translate%})<br /> \
                ------<br />\
                {%counts.all%} {%"page.rightSidebar.on_map"|translate%} ({%counts.worlds[1]%} | {%counts.worlds[2]%})<br />\
