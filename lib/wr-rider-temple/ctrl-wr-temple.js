angular.module("trialsTrackmap")
    .controller("wrTemple", function (
        ...
        $scope.selectedView = urlHandler.get("view") || urlHandler.read("view") || 'combined';

        $scope.toggleView = function () {
            $scope.selectedView = $scope.selectedView !== 'separated' ? 'separated' : 'combined';
            urlHandler.set({view: $scope.selectedView});
            $scope.getRider();
        };

        $scope.sort = function (type) {
            if ($scope.selectedView === 'separated') {
