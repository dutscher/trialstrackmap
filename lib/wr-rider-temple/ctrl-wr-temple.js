angular.module("trialsTrackmap")
    .controller("wrTemple", function ($scope, urlHandler, WRTimes) {
        ...
        $scope.sort = function (type) {
            ...
            os = raw[0];
            bikeType = raw[1];
            isNew = os !== $scope.selectedWrOS || bikeType !== $scope.selectedWrBikeType;
        ...
        $scope.getRider = function () {
            var sortedRider = WRTimes.getRiderSortedByOS($scope.data.rider, $scope.selectedWrOS, $scope.selectedWrBikeType, $scope.selectedWrSort);
