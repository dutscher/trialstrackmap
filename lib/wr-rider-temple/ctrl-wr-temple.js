angular.module("trialsTrackmap")
    .controller("wrTemple", function (
        ...
        $scope.toggleView = function (showView) {
            $scope.activeView = showView;
        ...
        $scope.getRider = function () {
            ...
            var leaderboard;
            if ($scope.activeView === "separated") {
                leaderboard = WRTimes.getRiderSortedByOS(
            ...
            } else if ($scope.activeView === "combined") {
                leaderboard = WRTimes.getRiderSortedByType(
                    parseInt($scope.selectedLeaderboardWorld)
                );
            } else if ($scope.activeView === "tracks") {
                leaderboard = WRTimes.getRiderSortedByTracks(
                    parseInt($scope.selectedLeaderboardWorld)
                );
            }

            $scope.allTrackCount = leaderboard.allTrackCount;
            $scope.allRiderCount = leaderboard.allRiderCount;
            $scope.leaders = leaderboard.leaders;
        };
