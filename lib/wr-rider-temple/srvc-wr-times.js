angular.module("trialsTrackmap")
    .service("WRTimes", function (myJson,
                                  $http, $q, $rootScope, $filter, $timeout) {

        var scope,
            leadersUrl = "http://tf.lforo.com/json/leaders.json",
            ...
            thisScope = {
                ...
                reload: function () {
                    return $http.get(leadersUrl).then(function (response) {
                        var convertedData = thisScope.parseTfLforoDataToOurs(response.data.leaders);
                ...
                parseTfLforoDataToOurs: function (_data_) {
                    var data = {
                        times: {},
                        rider: {}
                    };
