angular.module("trialsTrackmap")
    .service("WRTimes", function (myJson, $q, $rootScope, $filter, $timeout) {
        ...
        var scope,
            ...
            tailRider: null,
            allRiderCount: 0,
            getRiderSortedByOS: function(allRider, sortByOS, sortByBike, sortDirection){
                var modes, bikes, returnRider, sortRider,
                    thisScope = this;
                ...
                bikes = this.improveTimes.getBikes(true);
                returnRider = [];
                ...
                Object.keys(sortRider).forEach(function (os) {
                    ...
                    // sort by amount
                        ...
                        var x, y,
                            first, second,
                            bikeType = sortByOS && sortByOS === os && sortByBike
                                ? sortByBike
                                : "normal",
                            direction = sortByOS && sortByOS === os && sortDirection
                                ? sortDirection
