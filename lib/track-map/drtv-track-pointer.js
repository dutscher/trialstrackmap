angular.module("trialsTrackmap")
    .directive("trackPointer", function ($rootScope, $trackRadius, $parse, items) {
        return {
            restrict: "A",
            template: '\
            ...
            controller: function ($scope, $element, $attrs) {
                ...
                $rootScope.$on("filter:tracks", function (event, catId) {
                    $scope.type = items.getOpenForModalType(catId);
                });
