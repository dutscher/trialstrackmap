angular.module("trialsTrackmap")
    .controller("trackmap", function (improveTimes, categories, trackRadius, urlHandler,
        ...
        $scope.selectedWorld = urlHandler.get("world") || 1;
        $scope.worldImage = null;
        $scope.worldAlt = null;

        function setWorldData(){

            console.log("setWorldId", $scope.selectedWorld)

            var activeWorld = $scope.data.images.trackmaps[$scope.selectedWorld];
        ...
        $scope.changeWorld = function(newWorld){
            $scope.selectedWorld = newWorld;
            urlHandler.set({world: $scope.selectedWorld});
