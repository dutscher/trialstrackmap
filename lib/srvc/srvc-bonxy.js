    ...
    .service("bonxyApi",
        function (localStorageService, security, $q, $http) {
            var host = "https://api.myjson.com/bins/",
                ...
                leadersUrl = "https://jsonp.afeld.me/?url=http://api.willy-selma.de/tf/wr",
                leadersBackupUrl = "/dist/json/wrrider.json",
                searchUrl = "{{os}}/profile/search?nick={{profileName}}",
                //profileUrl = host + "10texl",
                profileUrl = "https://jsonp.afeld.me/?url=http://api.willy-selma.de/tf/dutscher",
            ...
            var thisScope = {
                ...
                getLeaders: function () {
                    var useLocalWr = false;
                    return $http.get(useLocalWr ? leadersBackupUrl : leadersUrl)
