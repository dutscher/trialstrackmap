        ...
        return {
            ...
            extendLevel: function (extraType, extra, spritePointer) {
                ...
                case "coins":
                    ...
                    level.sprite = "seasons";
                    break;
                // seperate listed items
                case "costum":
                    level.title = data.prizes.costums[extra].title;
                    level.costumSelector = data.prizes.costums[extra].selector;
                    level.costumPart = "costum--" + data.prizes.costums[extra].part;
                    level.css_selector = extraType;
                    level.price_indicator = extraType;
                    level.seperate_listed = true;
                    break;
                case "paintjob":
                    level.title = data.prizes.paintjobs[extra].title;
                    level.css_selector = "paintjob-icon-" + data.prizes.paintjobs[extra].sprite;
