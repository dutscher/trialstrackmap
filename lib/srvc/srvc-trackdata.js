angular.module("trialsTrackmap")
    .service("trackData", function ($trackRadius, improveTimes, categories,
        ...
        return {
            ...
            setFilterCatId: function (catId) {
                filterCatId = (!catId) ? defaultFilterCatId : catId;
            },
            ...
            getTracksInTiers: function (searchTrack) {
                var notTrackCategory = [6, 19],
                    ...
                    filterCat = filterCatId && filterCatId !== "" && filterCatId !== defaultFilterCatId;
                ...
                data.tracks.forEach(function (track, index) {
                    if (!onlyI18n) {
                        ...
                        if (trackId in data.media.candies) {
                            track.candy = data.media.candies[trackId];
                        }

                        // treasure
                        if (trackId in data.media.treasures) {
                            var items = data.media.treasures[trackId];
