angular.module("trialsTrackmap")
    .service("trackData", function (
        $trackRadius, WRTimes, categories, trackStats,
        ...
        var thisScope = {
            ...
            generateTracks: function (onlyI18n) {
                data.trackdata.ids.forEach(function (track) {
                    if (!onlyI18n) {
                        ...
                        track.times.worldRecord = WRTimes.getOne(trackId);
                        ...
                        // improve time
                        track.improve = WRTimes.improveTimes.getOne(trackId, track);
                    }
            ...
            getTracksInTiers: function (searchTrack, whoIs) {
                ...
                data.trackdata.ids.forEach(function (track) {
                    ...
                    if (track.categories.length === 0 || track.categories.length === 1
                            && notTrackCategory.indexOf(track.categories[0]) !== -1) {
        ...
        thisScope.WRTimes = WRTimes.extend("trackData", thisScope);
