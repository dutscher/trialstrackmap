        ...
        return {
            ...
            getTracksInTiers: function (searchTrack) {
                ...
                data.trackdata.ids.forEach(function (track) {
                    ...
                    if (!isSearch && track.world !== worldId) {
                    ...
                    track.categories.forEach(function (catId) {
                        ...
                        var catObject = categories.findById(catId),
                            isNoneGameCategory = catObject.hasOwnProperty("noneGameCategory");
            ...
            generateTracks: function (onlyI18n) {
                data.trackdata.ids.forEach(function (track, index) {
                    if (!onlyI18n) {
                    ...
                    track.categories = track.cats.split(",").map(Number);
                });
            ...
            getTracksOfCat: function (catId) {
                return $filter("catAndTierTracks")(data.trackdata.ids, catId);
            },
