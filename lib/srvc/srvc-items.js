    ...
    .service("items", function ($filter) {
        ...
        return {
            ...
            getSpecialsCats: function () {
                return [dataCubesId, treasurePieceId, youtubeVideosId, seasonReward]; // , eggsId
            },
            ...
            addItemsToTrack: function (track) {
                ...
                // startline
                if (trackId in trackData.trackdata.startlines && trackData.trackdata.startlines[trackId] !== "") {
