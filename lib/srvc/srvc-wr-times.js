                            ...
                            bikeTypeKeys.forEach(function (bikeType) {
                                ...
                                Object.keys(times).forEach(function (trackId) {
                                    var timesOfOS = times[trackId][os][bikeType],
                                        // json to string and do a regexp
                                        matches = JSON.stringify(timesOfOS).match(regexp);

                                    amount[os][bikeType] += parseInt(matches ? matches.length : 0, 10);

                                    // if (amount[os][bikeType] == 1) {
                                    //     console.log(riderId, trackId)
                                    //     if(!(os in tracks)) {
                                    //         tracks[os] = {};
                                    //     }
                                    //     tracks[os][bikeType] = trackId;
                                    // }
                                });
                            });
                        });
