        ...
        var scope,
            ...
            thisScope = {
                ...
                getRiderCountry: function(riderName) {
                    var country = "";
                    convertKeys.forEach(function (_country) {
                        var regxp = new RegExp("(-|_)" + _country + "$|^" + _country + "(-_-|-|_)", "i");
                        var match = riderName ? riderName.match(regxp) : null;

                        if (match !== null) {
                            country = (_country in convertPattern) ? convertPattern[_country] : _country;
                        }
                    });
                    return country;
                },
