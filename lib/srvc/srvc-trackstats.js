            ...
            get: function (_tracks_) {
                ...
                _tracks_.forEach(function (track) {
                    var isBunkerOnly = (types.bunker in track) && track[types.bunker],
                        ...
                        withoutStartline = !("startline" in track) || track.startline === "",
                        worldId = track.world,
                    ...
                    // not released
                    if (withoutCoordinates && !isBunkerOnly && !isEventOnly || withoutCategory || withoutStartline) {
                    ...
                    if (withoutStartline) {
                        counts.withoutStartline.push(track);
                    }
